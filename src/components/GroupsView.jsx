...
// Ordena los terceros de cada grupo por los criterios FIFA (puntos, diferencia
// de goles, goles a favor). Los 8 primeros clasifican a dieciseisavos.
function rankThirds(groups, letters) {
  const thirds = [];
...
export default function GroupsView({ tournament }) {
  ...
  const thirds = rankThirds(groups, letters);
